...
; do
	...
	for vendorVariant in \
		temurin-{noble,jammy,alpine{3.22,3.21,3.20},ubi{10,9}-minimal} \
		openjdk-{{,slim-}{trixie,bookworm},alpine{3.22,3.21},oraclelinux{9,8}} \
		corretto-{al2023,al2,alpine{3.22,3.21,3.20,3.19}} \
