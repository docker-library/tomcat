...
; do
	...
	for vendorVariant in \
		temurin-{resolute,noble,jammy,alpine{3.23,3.22,3.21,3.20},ubi{10,9}-minimal} \
		\
		openjdk-{{,slim-}{trixie,bookworm},alpine{3.23,3.22,3.21},oraclelinux{10,9,8}} \
		\
		azul-zulu-{debian13,alpine3.23} \
