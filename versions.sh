...
; do
	...
	for vendorVariant in \
		temurin-{noble,jammy,focal,alpine,ubi9-minimal} \
		openjdk-{{,slim-}{bookworm,bullseye,buster},alpine{3.20,3.19,3.18,3.17,3.16},oraclelinux{9,8}} \
		corretto-{al2023,al2,alpine{3.20,3.19,3.18,3.17,3.16}} \
		sapmachine-{noble,jammy,focal} \
		semeru-{noble,jammy,focal} \
	; do
